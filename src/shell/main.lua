...
local function tickActive(self, delta)
    ...
    local function solveBallistics(pos_hit, radius)
        ...
        hit, hit_distance, _, shape_initial = QueryRaycast(position_new, VecNormalize(VecSub(self.position, position_new)), VecLength(VecSub(self.position, position_new)), radius)
