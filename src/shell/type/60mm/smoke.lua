...
function ShellSecTickSmoke(self, _, variant)
    ...
    if not FdAssertTableKeys(self.secondary, "init") then
        ...
        doIgnitedWP(self, variant)
        doBodyPrimary(self, variant)

        doMushroomHead(self, variant, velocity, nil, nil, nil, Vec(0, 6, 0))
        ...
        for i = 1, heads, 1 do
            ...
            doMushroomHead(self, variant, velocity, range, size, { pitch, heading }, nil, distance)
        end
    end
